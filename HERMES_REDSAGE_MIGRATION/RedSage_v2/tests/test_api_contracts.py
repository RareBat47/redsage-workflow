...
CANONICAL_ROUTE_CONTRACT = frozenset({
    ...
    ("GET", "/api/v1/projects/{project_id}/tasks/{task_id}/steps"),
    ("POST", "/api/v1/projects/{project_id}/tasks/{task_id}/steps"),
    ("PUT", "/api/v1/projects/{project_id}/tasks/{task_id}/steps/{step_id}"),
    ("POST", "/api/v1/projects/{project_id}/tasks/{task_id}/steps/{step_id}/state"),
    ("POST", "/api/v1/projects/{project_id}/tasks/{task_id}/steps/{step_id}/verify"),
    ("GET", "/api/v1/projects/{project_id}/tasks/{task_id}/mentor/history"),
    ("POST", "/api/v1/projects/{project_id}/workflow/generate"),
    ("POST", "/api/v1/projects/{project_id}/workflow/apply"),
    ("GET", "/api/v1/projects/{project_id}/workflow/digest"),
    ("POST", "/api/v1/projects/{project_id}/mentor/boss"),
    ("GET", "/api/v1/projects/{project_id}/mentor/boss/history"),
